...
<head>
  ...
  <link rel="stylesheet" href="{{ asset('admin_asset/assets/css/components.css')}}">
</head>
  ...
  <script src="{{ asset('admin_asset/assets/js/stisla.js')}}"></script>
  ...
  <script src="{{ asset('admin_asset/assets/js/page/index-0.js')}}"></script>
        ...
        <div class="row">
          <div class="col-12 col-sm-8 offset-sm-2 col-md-6 offset-md-3 col-lg-6 offset-lg-3 col-xl-4 offset-xl-4">
            <div class="login-brand">
              <img src="{{ asset('admin_asset/assets/img/stisla-fill.svg')}}" alt="logo" width="100" class="shadow-light rounded-circle">
            </div>
