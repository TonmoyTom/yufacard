  ...
  <div class="content-viewport">
    <div class="row">
      <div class="col-lg-6 equel-grid">
        <div class="grid">
          <p class="grid-header">Add New Card Type
</p>
          <div class="grid-body">
            <div class="item-wrapper">
              <form action="{{url('save-category')}}" method="post">
                ...
                <div class="form-group">
                  ...
                  <input type="text" required="" class="form-control" name="category_name" id="inputCard" placeholder="Enter your Card Type">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <input type="text" name="description" class="form-control" id="inputDescription" placeholder="Enter your Description">
                </div>
