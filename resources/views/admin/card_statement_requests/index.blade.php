  ...
  <div class="viewport-header">
    <nav aria-label="breadcrumb">
      <ol class="breadcrumb has-arrow">
        ...
        <li class="breadcrumb-item">
          <a href="{{url('/view-card-statement-requests')}}">Orders</a>
        </li>
        <li class="breadcrumb-item active" aria-current="page">View Card Statement</li>
      </ol>
    </nav>
  </div>
<?php
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    ...
                    <a class="btn btn-info" target="_blank" href="{{url('add-statement/'.$data->id)}}">Add/View Statement</a>

                    <a class="btn btn-danger" href="{{url('delete-card-statement/'.$data->id) }}">Delete</a>
